...
CREATE TABLE `biddingproduct` (
  ...
  `uname` varchar(30) DEFAULT NULL,
  `uname2` varchar(30) DEFAULT NULL,
  `topprice2` varchar(30) DEFAULT NULL,
  `uname3` varchar(30) DEFAULT NULL,
  `topprice3` varchar(30) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `biddingproduct` VALUES ('E4.220106829767872E7','1','2014-10-12 00:00:00','2014-12-12 00:00:00','15$','15','jagraj',NULL,NULL,NULL,NULL),('E4.220106829767872E7','2','2014-10-12 00:00:00','2014-12-12 00:00:00','100','150','jagraj',NULL,NULL,NULL,NULL),('E4.220106829767872E7','4','2014-10-12 00:00:00','2014-12-12 00:00:00','15$','15','jagraj',NULL,NULL,NULL,NULL);
...
INSERT INTO `eventexhibitor` VALUES ('E4.220106829767872E7','jagraj'),('E7.155175555400835E7','jaadu'),('E7.155175555400835E7','jasmeet'),('E7.155175555400835E7','jagraj');
...
INSERT INTO `events` VALUES ('E4.220106829767872E7','Painting Art','paintings will be displayed','toronto','0015-05-12','0015-06-13','Jagraj Sidhu'),('E7.155175555400835E7','Tech Art','technology gadgets','scarborugh','2014-12-12','2014-12-14','komal ji');
...
INSERT INTO `login` VALUES ('admin','admin','admn'),('harihar305915','har41611hari93','orgn'),('jaadu','jaadu','exbt'),('jagraj','jagraj','exbt'),('jasmeet','jasmeet','exbt'),('lol','lol','rusr'),('raman','raman','orgn'),('rupam','rupam','orgn');
...
INSERT INTO `notification` VALUES ('admin','hi','2014-07-12','notviewed'),('admin','bye','2014-07-12','notviewed'),('jaadu','Congratulation!!! You have been invited to participate in new event E7.155175555400835E7.','2014-12-08',NULL),('jasmeet','Congratulation!!! You have been invited to participate in new event E7.155175555400835E7.','2014-12-08',NULL),('jagraj','Congratulation!!! You have been invited to participate in new event E7.155175555400835E7.','2014-12-08',NULL);
...
INSERT INTO `products` VALUES ('1','A','A','a.jpg','10','bidd','jagraj','special'),('2','B','B','b.jpg','11','bidd','jagraj','special'),('3','C','C','c.jpg','13','bidd','jaadu','special'),('4','D','D','d.jpg','15','sale','jagraj','special'),('5','E','E','e.jpg','20','sale','jagraj','hotdeal');
...
INSERT INTO `users` VALUES ('harihar305915','hari','hari@hotmail.com','4161121223','peterborough'),('jaadu','jaadu','abc@abc.com','123232','56 rererst'),('jagraj','Jagraj Singh','jagraj.brar@gmail.com','4166255096','centennial college'),('jasmeet','jasmeet','jasmeet@gmail.com','415656895','centennial college'),('lol','lol','lol@lol.com','123232','lol'),('raman','raman','lkmcd','lkfd','ABC street'),('rupam','Rup Grewal','jdhdh@hsuj.con','4204230420','123 Chor gali');
...
-- Dump completed on 2014-12-11 12:53:17
