	    			...
	    			try {
	    				...
	    				st.executeUpdate("Insert into products(productid,producttitle,description,image,price,type,exhibitoruname,kind) "
	    						+ "values('"+product.getProductId()+"','"+product.getProductTitle()+"','"+product.getDescription()+"'"
	    								+ ",'"+product.getImage()+"'"+ ",'"+product.getPrice()+"','"+product.getType()+"'"
	    									+ ",'"+product.getExhibitorUname()+"'"+ ",'"+product.getKind()+"')");
...
try {
	    			...
	    			return false;
							...
							public Map<String, SoldProduct> getAllSoldProducts() {
								Map<String,SoldProduct> soldproducts=new HashMap<String, SoldProduct>();
				    			...
				    			try {
				    			    ...
				    			    while(rs.next())
				    			    {
				    			    	soldproducts.put(rs.getString(1),new SoldProduct(getEventById(rs.getString(1)),getProductById(rs.getString(2)),rs.getString(3)));
